...
class LogHandler:
    ...
    def __init__(self, name, level=logging.INFO, fmt="%(asctime)s - %(levelname)s - %(message)s", output="console", include_filter=None, exclude_filter=None, file_filter=None, level_filter=None, rolling_type=None, rolling_value=None, backup_count=5):
        """
